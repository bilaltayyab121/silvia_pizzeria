      ...
      <div className="relative flex h-full w-full max-w-md flex-col bg-white shadow-2xl transition-transform">
        ...
        {cart.length > 0 && (
          <div className="border-t border-slate-100 bg-slate-50 p-6">
            ...
            <button
              onClick={sendOrder}
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-italian-green py-4 text-base font-bold text-white shadow-lg transition hover:bg-emerald-600 active:scale-95"
            >
