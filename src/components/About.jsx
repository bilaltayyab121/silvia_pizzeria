      ...
      <SectionTitle
        ...
        description={
          language === "fr"
            ...
            : "Silvia Pizzeria is a family-run restaurant where every pizza is made with fresh ingredients and every guest is welcomed like home."
        }
      />
        ...
        <div className="space-y-4 rounded-xl bg-italian-cream p-6 text-slate-900 shadow-soft">
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold">
              {language === "fr" ? "Ingrédients frais" : "Fresh Ingredients"}
            </span>
          </div>
          <div className="flex items-center gap-3">
            <MapPin className="h-6 w-6 text-italian-green" />
            <span className="font-semibold">
              {language === "fr" ? "Vue sur la mer" : "Sea View Location"}
            </span>
          </div>
          <div className="flex items-center gap-3">
            ...
            <span className="font-semibold">
              {language === "fr"
                ? "Livraison avec Yassir"
                : "Delivery with Yassir"}
            </span>
          </div>
          <div className="flex items-center gap-3">
            <Wheat className="h-6 w-6 text-italian-green" />
            <span className="font-semibold">
              {language === "fr" ? "Spécialités" : "House Specialties"}
            </span>
          </div>
        </div>
      </div>
